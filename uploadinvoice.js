...
async function uploadinvoice({applicationId, invoiceNo, invoiceDate, netpayble},{userid, password},fileName) {
  ...
  try {
    ...
    await page.waitForSelector('#kt_header_menu > ul > li:nth-child(3) > a');
    await page.click('#kt_header_menu > ul > li:nth-child(3) > a');
    await page.waitForTimeout(5000); // wait for 5 seconds
    console.log("header menu selection completed",applicationId);

    await page.waitForSelector('#kt_header_menu > ul > li.kt-menu__item.kt-menu__item--submenu.kt-menu__item--rel.ng-star-inserted.kt-menu__item--open-dropdown > div > ul > li > a');
    ...
    await page.waitForSelector('td[data-title="Application ID"] > span> a');
    await page.click('td[data-title="Application ID"] > span> a');
    await page.waitForTimeout(5000);

    await page.waitForSelector('#kt_content > div > kt-application-details > div.kt-portlet.kt-portlet--tabs > div > div > ul > li:nth-child(6) > a');
    await page.click('#kt_content > div > kt-application-details > div.kt-portlet.kt-portlet--tabs > div > div > ul > li:nth-child(6) > a');
    await page.waitForTimeout(5000);

    await page.waitForSelector('#kt_content > div > kt-application-details > div.kt-container-alt > kt-credit-line-withdrawal > div > div > div > div.kt-portlet__head > div.kt-portlet__head-toolbar > button');
    ...
    await page.waitForSelector('mat-bottom-sheet-container > kt-withdrawal-request-form > form > button');
    await page.click('mat-bottom-sheet-container > kt-withdrawal-request-form > form > button');
    await page.waitForTimeout(7000);

    await page.waitForSelector('#kt_content > div > kt-application-details > div.kt-container-alt > kt-credit-line-withdrawal > div > div > div > div.kt-portlet__body > table > tbody > tr:nth-child(2) > td:nth-child(2) > form > table > tbody > tr > td:nth-child(1) > input');
    ...
    //invoice date
    await page.waitForSelector('#kt_content > div > kt-application-details > div.kt-container-alt > kt-credit-line-withdrawal > div > div > div > div.kt-portlet__body > table > tbody > tr:nth-child(2) > td:nth-child(2) > form > table > tbody > tr > td:nth-child(3) > div > input');
    //await page.click('#kt_content > div > kt-application-details > div.kt-container-alt > kt-credit-line-withdrawal > div > div > div > div.kt-portlet__body > table > tbody > tr:nth-child(2) > td:nth-child(2) > form > table > tbody > tr > td:nth-child(1) > input');
    ...
    await page.waitForSelector('#kt_content > div > kt-application-details > div.kt-container-alt > kt-credit-line-withdrawal > div > div > div > div.kt-portlet__body > table > tbody > tr:nth-child(2) > td:nth-child(2) > form > table > tbody > tr > td:nth-child(3) > div > div > button');
    ...
    await page.waitForSelector('#kt_content > div > kt-application-details > div.kt-container-alt > kt-credit-line-withdrawal > div > div > div > div.kt-portlet__body > table > tbody > tr:nth-child(2) > td:nth-child(2) > form > table > tbody > tr > td:nth-child(4) > input');
    //await page.click('#kt_content > div > kt-application-details > div.kt-container-alt > kt-credit-line-withdrawal > div > div > div > div.kt-portlet__body > table > tbody > tr:nth-child(2) > td:nth-child(2) > form > table > tbody > tr > td:nth-child(1) > input');
    ...
    await page.waitForSelector('#invoice_file');
    await page.waitForTimeout(1000);
    ...
    await page.waitForSelector('#kt_content > div > kt-application-details > div.kt-container-alt > kt-credit-line-withdrawal > div > div > div > div.kt-portlet__body > table > tbody > tr:nth-child(2) > td:nth-child(2) > form > table > tbody > tr > td.text-right > button');
    ...
    console.log("invoice creation complete",applicationId);
    return {
      "fstatus":'success',
